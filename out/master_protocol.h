...
#define KALMAN_STATUS_MASTERSTATUS_CAN_STATUS_HEALTH_CHECK_OK_1 0
#define KALMAN_STATUS_MASTERSTATUS_CAN_STATUS_HEALTH_CHECK_WARNING_2 1
#define KALMAN_STATUS_MASTERSTATUS_CAN_STATUS_HEALTH_CHECK_WARNING_3 2
#define KALMAN_STATUS_MASTERSTATUS_CAN_STATUS_HEALTH_CHECK_CRITICAL_4 255
#define KALMAN_STATUS_MASTERSTATUS_CAN_STATUS_HEALTH_CHECK_CRITICAL_5 255
#define KALMAN_STATUS_MASTERSTATUS_CAN_STATUS_HEALTH_CHECK_CRITICAL_6 255
#define KALMAN_STATUS_MASTERSTATUS_CAN_STATUS_HEALTH_CHECK_CRITICAL_7 255
...
#define KALMAN_STATUS_DEVICESALIVE_WHEELS_HEALTH_CHECK_CRITICAL_1 0       
#define KALMAN_STATUS_DEVICESALIVE_WHEELS_HEALTH_CHECK_WARNING_2_MIN 1
#define KALMAN_STATUS_DEVICESALIVE_WHEELS_HEALTH_CHECK_WARNING_2_MAX 3
#define KALMAN_STATUS_DEVICESALIVE_WHEELS_HEALTH_CHECK_OK_3 4
